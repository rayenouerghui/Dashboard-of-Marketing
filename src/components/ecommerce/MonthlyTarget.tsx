...
export default function MonthlyTarget({ stats }: { stats: AttractionLeadStats }) {
    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="rounded-2xl bg-white p-5 shadow-default dark:bg-gray-900 sm:p-6">
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Physical attraction leads this week, with {monthName} total below.
        </p>

        <div className="mt-6 rounded-2xl border border-brand-200 bg-brand-50 p-5 dark:border-brand-500/20 dark:bg-brand-500/10">
          <p className="text-sm font-medium text-brand-700 dark:text-brand-300">Leads this week</p>
